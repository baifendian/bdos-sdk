...
public class ApiSessionCredentialsFetcher {
...
//    private String metadataServiceHost = "100.100.100.200";
    ...
    public ApiSessionCredentialsFetcher(String accessKeyId, String accessKeySecret) {
...
//    }
    ...
    public ApiSessionCredentialsFetcher withConnectionTimeout(int milliseconds) {
